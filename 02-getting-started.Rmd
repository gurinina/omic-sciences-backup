...
File > New Project > Version Control > Git. In the “repository URL” paste the URL of your new GitHub repository. Paste in https://github.com/gurinina/omic_sciences
...
This should copy all of be the course material into this project and should be all you need for the course. Homework assignments will be posted on Canvas on a weekly basis.

The published book version of the Rmd files for the course is available [here](https://bookdown.org/ggiaever/omic_sciences/).
